...
if __name__ == "__main__":
	ClassifyChunk("test.txt",["training_business.txt","training_computer.txt","training_health.txt","training_politics.txt","training_sports.txt"],TrainEnsemble(["training_business.txt","training_computer.txt","training_health.txt","training_politics.txt","training_sports.txt"]))
	# ChunkClusters = 
