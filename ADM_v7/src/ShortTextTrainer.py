...
def driver(start):
	try:
		print(time.ctime())
		filenames = ['business.chunk','engineering.chunk','computers.chunk','health.chunk','culture-arts-entertainment.chunk','politics-society.chunk','education-science.chunk','sports.chunk']
